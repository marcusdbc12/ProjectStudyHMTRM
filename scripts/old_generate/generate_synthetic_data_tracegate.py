...
Variant 2: direct-arrival trace gating before time reversal.
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Generate synthetic j-Wave data with trace-gated numerical TRM")
...
def main() -> None:
    ...
    for i in range(args.samples):
        ...
        logging.info("Applied direct-arrival gating with margin_time=%g s", margin_time)
    ...
    manifest = {
        ...
        "si_speed_m_per_s": args.si_speed,
        "notes": (
            "One-source trace-gated numerical TRM dataset. "
